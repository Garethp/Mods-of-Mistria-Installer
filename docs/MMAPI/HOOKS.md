...
The shipped catalog currently declares **106 hooks**, fed by **116 seams**, **24 engine fixes**, and **1 call rewrite**. The [Catalog](CATALOG.md) gives each one its own page.
