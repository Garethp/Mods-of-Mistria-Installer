...
The shipped catalog currently declares **122 hooks**, fed by **133 seams**, **6 engine fixes**, and **1 call rewrite**. The [Catalog](CATALOG.md) gives each one its own page.
