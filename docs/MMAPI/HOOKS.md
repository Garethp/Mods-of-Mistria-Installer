...
The shipped catalog currently declares **137 hooks**, fed by **153 seams**, **9 engine fixes**, and **1 call rewrite**. The [Catalog](CATALOG.md) gives each one its own page.
