...
| **Locator** | structural target: `put_down`, at after `obj_ari.par.held_animal_render_callback = undefined;` (the function's last statement) |
| **Op** | `emit` |
