...
- [game_step_begin_installs](game_step_begin_installs.md) - This engine fix drives the poll that derives [game.day_started](../hooks/game.day_started.md), the observation-side counterpart.
