...
The shipped catalog currently declares **104 hooks**, fed by **114 seams**, **4 engine fixes**, and **1 call rewrite**. The [Catalog](CATALOG.md) gives each one its own page.
