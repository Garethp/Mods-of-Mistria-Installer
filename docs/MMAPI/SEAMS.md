...
The shipped catalog currently declares **101 hooks**, fed by **109 seams**, **4 engine fixes**, and **1 call rewrite**. The [Catalog](CATALOG.md) gives each one its own page.
