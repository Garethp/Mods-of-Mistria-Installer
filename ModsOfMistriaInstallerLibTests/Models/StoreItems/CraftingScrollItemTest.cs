...
[TestFixture]
public class CraftingScrollItemTest
{
    ...
    {
        var item = new CraftingScrollStoreItem()
        {
            Store = "general store",
            Category = "general category",
            Item = new CraftingScrollItemDefinition { CraftingScroll = "test crafting item" }
        };
    ...
    public void ShouldGenerateJsonCorrectly()
    {
        ...
        {
            { "crafting_scroll", item.Item.CraftingScroll }
        };
