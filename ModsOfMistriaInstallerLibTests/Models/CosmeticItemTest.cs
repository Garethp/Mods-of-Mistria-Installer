...
public class CosmeticItemTest
{
    ...
    private static CosmeticItem GetMockItem()
    {
        var item = new CosmeticItem()
        {
            Store = "general store",
            Category = "general category",
            Item = new CosmeticDefinition { Cosmetic = "test item" }
        };
    ...
    public void ShouldHaveErrorIfNoStoreCategoryDefined()
    {
        ...
        expectedValidation.AddError(_mockMod, "storeItem.json",
            string.Format(Resources.ErrorStoreItemHasNoCategory, "general store"));
    ...
    public void ShouldHaveErrorIfSeasonIsIncorrect()
    {
        ...
        var expectedValidation = new Validation();
        expectedValidation.AddError(_mockMod, "storeItem.json",
            string.Format(Resources.ErrorStoreItemHasInvalidSeason, item.Store, item.Category, "invalid"));
    ...
    public void ShouldHaveErrorIfItemIsEmpty()
    {
        ...
        var expectedValidation = new Validation();
        expectedValidation.AddError(_mockMod, "storeItem.json",
            string.Format(Resources.ErrorStoreItemHasNoItem, item.Store, item.Category));
